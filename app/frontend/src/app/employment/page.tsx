...
const YEAR_ANALYSIS: YearAnalysis[] = [
  { year: '2001', avgScore: 33, range: '3-46', phase: 'EXPANSION→SLOWDOWN→CAUTION', scores: 'E=29 C=0 S=3',
    situation: 'ITバブル崩壊。NASDAQ -78%。9/11テロ。3月にNBERがリセッション認定。',
    verdict: 'SLOWDOWN→CAUTIONへの悪化を検出。雇用スコア(E=29)がITバブル後の雇用喪失を反映' },
  { year: '2002', avgScore: 41, range: '28-49', phase: 'SLOWDOWN→CAUTION', scores: 'E=37 C=0 S=3',
    situation: 'エンロン・ワールドコム破綻。企業会計スキャンダル。ダブルディップ懸念。',
    verdict: 'CAUTION判定が支配的。雇用悪化(E=37)が継続。偽陽性ではなく実際の景気後退期' },
  { year: '2003', avgScore: 34, range: '16-51', phase: 'CAUTION→SLOWDOWN→EXPANSION', scores: 'E=26 C=0 S=5',
    situation: 'イラク戦争開始(3月)。景気回復開始。FRBが1%まで利下げ。',
    verdict: 'H1はCAUTION、H2にEXPANSIONへ。回復の過程を正確に反映' },
  { year: '2004', avgScore: 11, range: '5-19', phase: 'EXPANSION', scores: 'E=7 C=0 S=4',
    situation: '景気拡大。住宅ブーム加速。FRBが利上げ開始(6月)。',
    verdict: '完全なEXPANSION。ITバブル後の回復完了' },
  { year: '2005', avgScore: 4, range: '0-12', phase: 'EXPANSION', scores: 'E=3 C=0 S=1',
    situation: '住宅バブルのピーク。サブプライムローン急拡大。雇用は絶好調。',
    verdict: 'avg 4ptで最も健全な年。雇用市場はバブル崩壊前の最良期' },
  { year: '2006', avgScore: 9, range: '0-23', phase: 'EXPANSION→SLOWDOWN', scores: 'E=6 C=0 S=2',
    situation: '住宅市場にピークの兆し。製造業は堅調。年末に減速の兆候。',
    verdict: '表面的にはEXPANSION。住宅市場の悪化はまだ雇用に波及せず' },
  { year: '2007', avgScore: 31, range: '13-52', phase: 'EXPANSION→SLOWDOWN→CAUTION', scores: 'E=16 C=2 S=11',
  ...
  { year: '2008', avgScore: 74, range: '52-84', phase: 'CAUTION→CONTRACTION→CRISIS', scores: 'E=40 C=16 S=14',
    ...
    verdict: 'CAUTION→CONTRACTION(8ヶ月)→CRISIS(12月84pt)。段階的悪化を正確に反映' },
  { year: '2009', avgScore: 83, range: '79-88', phase: 'CRISIS→CONTRACTION', scores: 'E=42 C=16 S=21',
    situation: 'GFC最悪期。失業率10%到達。3月にS&P500が底値(666)。',
    verdict: 'CRISIS判定が11ヶ月。88pt(1月)がモデル史上最高スコア' },
